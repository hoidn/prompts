...
```json
{
  "task": {
    ...
    "spec_references": [
      "spec-db-data.md § Data Loading",
      "spec-db-data.md § Distributed Sharding"
    ]
  }
}
```
...
- [SPEC-DATA § 1. Data Loading](../spec-shards/spec-db-data.md#1-data-loading)
- [SPEC-DATA § 4. Distributed Sharding](../spec-shards/spec-db-data.md#4-distributed-sharding)

**Contract compliance:**
- `PtychographyDataset.__getitem__` satisfies [SPEC-DATA § 2.5 Output Format]
- `RankShardedSubset` satisfies [SPEC-DATA § 4.2 Sharding Formula]
```
...
- [SPEC-DATA § 1. Data Loading](spec-db-data.md#1-data-loading)
- [SPEC-DATA § 2. Data Preprocessing](spec-db-data.md#2-data-preprocessing)
```
