...
2. Review related artifacts under `plans/active/<initiative-id>/reports/` and the corresponding plan files (`plans/nanobrag_integration_plan.md`, etc.).
3. Update the ledger entry:
   ...
   - Reference specs/tests (e.g., `docs/spec-db-conformance.md:24`) when clarifying exit criteria.
